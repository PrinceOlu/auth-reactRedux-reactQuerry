...
const Register = () => {
   ...
   const mutation = useMutation({
    ...
    mutationKey: ['register'],  // Fixed typo
  });
  // create an instance of navigate
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="max-w-md w-full space-y-8 p-10 bg-white rounded-lg shadow-xl">
        ...
        {mutation.isSuccess && <AlertMessage type="success" message="Registration successful!" />}
        {mutation.isError && <AlertMessage type="error" message="user exists!" />}
